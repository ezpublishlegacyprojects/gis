<?php
/*!
  \class   ezgistype ezgistype.php
  \ingroup eZDatatype
  \brief   Handles the datatype gis. By using gis you can ...
  \version 1.0
  \date    Freitag, 27.Januar 2005 01:58:58
    ...
    */
    function validateObjectAttributeHTTPInput( &$http, $base, &$contentObjectAttribute )
    {
    	...
    	if ( $http->hasPostVariable( $base . '_ezgis_longitude_' . $contentObjectAttribute->attribute( 'id' ) ) and $http->hasPostVariable( $base . '_ezgis_latitude_' . $contentObjectAttribute->attribute( 'id' ) ) )
        {
        	...
        	if ( !empty( $update ) or $http->postVariable( $base . '_ezgis_latitude_' . $contentObjectAttribute->attribute( 'id' ) ) == "" 
					AND $longitude = $http->postVariable( $base . '_ezgis_longitude_' . $contentObjectAttribute->attribute( 'id' ) ) == "" )
			{
				#$url=YahooGeocoder::buildURL();
				...
				#echo "Link: $requestUrl";
				
				if (!empty($city) OR !empty($state) )
				{
