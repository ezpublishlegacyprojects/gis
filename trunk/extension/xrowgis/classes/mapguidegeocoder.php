...
//
// Definition of MapGuideGeoCoder Methods
//
// MapGuideGeoCoder Methods
//
// Created on: <May-2012 Stephan Bogansky>
// Version: 0.0.1
//
...
class MapGuideGeoCoder extends GeoCoder
{
...
8     Address level accuracy. (Since 2.59)
	...
	*/
    ...
    function request()
    {
        ...
        $url = $gisini->variable( "MapGuide", "Url" );
        
        if ( $this->reverse )
        {
            $reverseUrl = $gisini->variable( "MapGuide", "ReverseUrl" );
        ...
        eZDebug::writeDebug( $requestUrl, 'MapGuide GeoCoder Request' );
